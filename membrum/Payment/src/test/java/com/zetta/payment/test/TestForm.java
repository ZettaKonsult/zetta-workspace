 ...
 * Tests Form objects.
 * <p>
 * Uses a {@link TRFForm} to test the abstract superclass' ({@link BasicForm})
 * methods.
 * 
 * @date 2017-11-14
 */
public class TestForm {
    ...
    public void bytes() throws UnsupportedEncodingException {
        ...
        Assert.assertArrayEquals(new byte[] {
                97, 99, 99, 101, 112, 116, 117, 114, 108, 61, 97, 38, 97, 109,
                111, 117, 110, 116, 61, 98, 38, 99, 97, 108, 108, 98, 97, 99,
                107, 117, 114, 108, 61, 99, 38, 99, 97, 110, 99, 101, 108, 117,
                114, 108, 61, 100, 38, 99, 117, 114, 114, 101, 110, 99, 121, 61,
                101, 38, 100, 101, 99, 111, 114, 97, 116, 111, 114, 61, 102, 38,
                105, 112, 61, 103, 38, 108, 97, 110, 103, 61, 104, 38, 109, 101,
                114, 99, 104, 97, 110, 116, 61, 105, 38, 111, 114, 100, 101,
                114, 105, 100, 61, 106, 38, 116, 101, 115, 116, 61, 107, 38,
                117, 110, 105, 113, 117, 101, 111, 105, 100, 61, 108
        }, form.bytes());
    }
    ...
    public void url() throws UnsupportedEncodingException {
        ...
        assertEquals("accepturl=a&amount=b&"
                ...
                + "lang=h&merchant=i&orderid=j&test=k&uniqueoid=l", form.url());
    }
