...
describe('PlanTemplate', () => {
  ...
  describe('getErrors()', () => {
    it('returns why the evaluation did not pass, simple example', () => {
      ...
      expect(pt.getErrors(simpleNotValidPlans)).toEqual(expect.objectContaining(expected))
    })
    it('returns why the evaluation did not pass, complex example', () => {
      ...
      expect(pt.getErrors(complexNotValidPlans)).toEqual(expect.objectContaining(expected))
    })
  })
